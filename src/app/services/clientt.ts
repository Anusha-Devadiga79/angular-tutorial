...
export class Clientt {
  ...
  getAllClientProject(): Observable<APIResponseModel> {
    return this.http.get<APIResponseModel>(environment.EMP_URL+Constant.API_METHOD.GET_ALL_PROJECT)
  }

  getAllEmployee(): Observable<APIResponseModel> {
    return this.http.get<APIResponseModel>(environment.EMP_URL+Constant.API_METHOD.GET_ALL_EMP)
  }
